...
*/
const tempCelsys = Number.parseFloat(prompt("Ведите температуру в град Цельсия: "));

function temptrans(t1) {
    tempFarengate = (9 / 5 * t1 + 32).toFixed(1);
    return tempFarengate;
}
alert(`Цельсий:, ${tempCelsys}, Фаренгейт:, ${temptrans(tempCelsys)}`);
